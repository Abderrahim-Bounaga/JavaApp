...
public class SampleController implements Initializable {
    ...
    public void addAction(ActionEvent actionEvent) {
        ...
        pobj.setID(Integer.parseInt(tfId.getText()));
        pobj.setAdress(tfAdress.getText());
        pobj.setType(tfType.getText());
        pobj.setSurface(tfSurface.getText());
        pobj.setPrice(Integer.parseInt(tfPrice.getText()));
        tvBooks.getItems().add(pobj);
        tfId.clear();
        tfAdress.clear();
        tfType.clear();
        tfSurface.clear();
